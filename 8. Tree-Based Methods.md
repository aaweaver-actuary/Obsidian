...
* Just as in the #regression setting, we use #recursive-binary-splitting to grow a #classification #tree.[^4]
...
* **PRO:** Some people believe that decision trees more closely mirror human decision-making than do the #regression and #classification approaches discussed in [[Classification|chapter 4]] and [[Resampling Methods|chapter 5]].

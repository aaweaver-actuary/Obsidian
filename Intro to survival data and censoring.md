...
- For example, if we have conducted a 5-year medical study in which patients have been treated for cancer
	- We want to fit a model to predict patient [[Survival Time|survival time]], using features like baseline health measurements or type of treatment
		- this sounds like a [[Regression|regression]] problem
		- but there is an issue:
			- some of the patients have survived the entire 5-year study
			- such a patient's [[Survival Time|survival time]] is said to be [[Censored Data|censored]]
